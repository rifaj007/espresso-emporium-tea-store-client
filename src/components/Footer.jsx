      ...
      <div className="flex mb-12">
        ...
        <div className="w-[505px]">
          ...
          <form onSubmit={handleContact}>
            <input className="w-full h-12 text-[#1B1A1A99] text-base p-3 rounded-md mb-4" type="text" name="name" placeholder="Name" />
            <br />
            <input className="w-full h-12 text-[#1B1A1A99] text-base p-3 rounded-md mb-4" type="email" name="email" placeholder="Email" />
            <br />
            <textarea className="w-full h-32 text-[#1B1A1A99] text-base p-3 rounded-md mb-6" name="message" placeholder="Message" rows="10"></textarea>

            <input className="text-2xl font-rancho text-[#331A15] border-2 border-[#331A15] rounded-[30px] py-2 px-5 cursor-pointer" type="submit" value="Send Message" />
          </form>
        </div>
      </div>

      {/* copyright */}
      <div className="h-[50px] bg-cover bg-center bg-no-repeat flex items-center justify-center" style={{backgroundImage: `url(${copyrightBg})`}}>
